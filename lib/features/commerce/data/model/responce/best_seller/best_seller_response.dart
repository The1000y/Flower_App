...
BestSellerResponse bestSellerResponseFromJson(String str) =>
    BestSellerResponse.fromJson(json.decode(str));

String bestSellerResponseToJson(BestSellerResponse data) =>
...
class BestSellerResponse {
  ...
  BestSellerResponse({this.data, this.isSuccess, this.message, this.errorCode});
