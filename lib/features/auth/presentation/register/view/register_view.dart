      ...
      child: BlocConsumer<AuthViewModel, AuthState>(
        listener: (context, state) {
          ...
          if (entity != null && !entity.isSuccess) {
            setState(
              () => _serverErrorMessage = 'Something went wrong',
            ); //حل مؤقت
            _formKey.currentState!.validate();
          } else if (entity != null && entity.isSuccess) {
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          Expanded(
                            child: CustomTextFormField(
                              ...
                              validator: (value) {
                                final localError = AuthValidators.firstName(
                                  value,
                                );
                          ...
                          Expanded(
                            child: CustomTextFormField(
                              ...
                              validator: (value) {
                                final localError = AuthValidators.lastName(
                                  value,
                                );
                                if (localError != null) return localError;
                                return _serverErrorMessage;
                      ...
                      CustomTextFormField(
                        ...
                        validator: (value) {
                          final localError = AuthValidators.email(value);
                          if (localError != null) return localError;
                          return _serverErrorMessage;
                        },
                      ),
                      ...
                      CustomTextFormField(
                        ...
                        validator: (value) {
                          final localError = AuthValidators.phone(value);
                          if (localError != null) return localError;
                          return _serverErrorMessage;
                        },
                      ),
