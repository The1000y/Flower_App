...
void main() {
  ...
  provideDummy<VerifyOtpRequest>(VerifyOtpRequest(email: '', otp: ''));
  ...
  group('AuthRepoImpl - VerifyOtp Tests', () {
    test(
      'verifyOtp should return SuccessResponce when data source succeeds',
      () async {
        // Arrange
    ...
    test(
      'verifyOtp should return ErrorResponce when data source fails',
      () async {
        // Arrange
        const email = 'user@example.com';
        const otp = 'invalid';
  ...
  group('AuthRepoImpl - ForgotPassword Tests', () {
    test(
      'should return SuccessResponce when localDataSource succeeds',
      () async {
    ...
    test('should return ErrorResponce when localDataSource fails', () async {
      ...
      when(
        mockLocalDataSource.forgotPassword(any),
  ...
  group('AuthRepoImpl - ResetPassword Tests', () {
    test(
      ...
      () async {
        ...
        when(
          mockLocalDataSource.resetPassword(any),
