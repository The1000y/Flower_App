...
void main() {
    ...
    return ScreenUtilPlusInit(
      ...
      builder: (context, child) => MaterialApp(
        ...
        routes: {
          ...
          Routes.trackOrder: (context) => const Scaffold(body: Text('Track Order')),
        },
      ),
    );
  }
  ...
  group('OrderSuccessView Interaction Tests', () {
    ...
    testWidgets('tapping track order button triggers navigation to trackOrder with orderId', (tester) async {
      await tester.pumpWidget(createWidgetUnderTest(orderId: '12345'));
    ...
    testWidgets('tapping back button triggers navigation to home', (tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
